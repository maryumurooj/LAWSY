...
function Home() {
  ...
  useEffect(() => {
    // Fetch the latest judgments on component mount
    const fetchJudgments = async () => {
      try {
        const response = await fetch('http://localhost:3000/api/latest-judgments');
    ...
    <div className={styles.homeContainer}>
      ...
      <div className={styles.homeJudgment}>
        {judgments.map((judgment) => (
          <div key={judgment.judgmentId} className={styles.row}>
            <div className={styles.content}>
              ...
              <div className={styles.judgmentParties}>
                {judgment.judgmentJudges}
              </div>
              <div className={styles.judgmentDate}>
                {judgment.formattedDOJ}
              </div>
