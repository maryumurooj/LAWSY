...
const CaseFinder = () => {
  ...
  useEffect(() => {
    console.log("Current judgmentCitationFromUrl:", judgmentCitationFromUrl);
    console.log("Session storage keys:", Object.keys(sessionStorage)); // Check if the citation is stored
    ...
    if (
      ...
      console.log("Stored judgment data:", storedJudgmentData); // Debugging
      ...
      if (storedJudgmentData) {
        ...
        console.log("No data in sessionStorage, fetching...");
        handleSearchById(judgmentCitationFromUrl); // Fetch data
      }
    }
  }, [location, contentFromUrl, judgmentCitationFromUrl]);
